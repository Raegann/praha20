...
var differentthemesButtons=[
		{
			...
			fields:[{id:'text', name:'Text'},{id:'icon', name:'Icon', values:uniqmag_different_themes_icons()},{id:'href', name:'Link URL'},{id:'color', name:'Color', value:'b70900', colorpalette:true},{id:'textcolor', name:'Text Color', colorpalette:true},{id:'target', name:'Target', values:['Self', 'Blank']},{id:'side', name:'Icon Side', values:['Left', 'Right']},{id:'size', name:'Size', values:['Default', 'Small', 'Large']}],
		...
		},		
		{
			...
			title:'Spacer',
			allowSelection:false,
			fields:[{id:'icon', name:'Icon', values:uniqmag_different_themes_icons()},{id:'color', name:'Color', value:'264C84', colorpalette:true }],
			generateHtml:function(obj){
		...
		{
			id:'differentthemesservice',
			image:'cpanel-btn-team-member.png',
			title:'Service Box',
			allowSelection:false,
			fields:[{id:'icon', name:'Icon', values:uniqmag_different_themes_icons()},{id:'align', name:'Align', values:['Left', 'Center', 'Right']},{id:'color', name:'Color', value:'264C84', colorpalette:true },{id:'title', name:'Title'},{id:'text', name:'Text', textarea:true}],
			generateHtml:function(obj){

				return '[service color="'+obj.color+'" icon="'+obj.icon+'" title="'+obj.title+'" align="'+obj.align.toLowerCase()+'"]'+obj.text+'[/service]';
		...
		},
		{
			...
			title:'Quote',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Style 1', 'Style 2']},{id:'quotetext', name:'Quote text', textarea:true},{id:'author', name:'Author'}],
			generateHtml:function(obj){
				switch(obj.style)
				{
					case 'Style 1':
				...
				return '[blockquote author="'+obj.author+'" style="'+style+'"]'+obj.quotetext+'[/blockquote]';
			}
		},
		{
			id:'differentthemesblocktext',
			image:'blockquotes.png',
			title:'Quote',
			allowSelection:false,
			fields:[{id:'align', name:'Align', values:['Left', 'Center', 'Right']},{id:'quotetext', name:'Quote text', textarea:true}],
			generateHtml:function(obj){
				return '[blocktext align="'+obj.align.toLowerCase()+'"]'+obj.quotetext+'[/blocktext]';
			}
		},
		{
			...
			title:'Pricing Table',
			allowSelection:false,
			fields:[{id:'featured', name:'Featured?', values:['No', 'Yes']},{id:'title', name:'Title'},{id:'subtitle', name:'Subtitle'},{id:'price', name:'Price'},{id:'period', name:'Period'},{id:'list', name:'Features, separate them with - ;', textarea:true},{id:'btntext', name:'Button Text'},{id:'href', name:'Button Link'},{id:'target', name:'Button Target', values:['Self', 'Blank']}],
			generateHtml:function(obj){
				var output = '';

				output+='[pricing title="'+obj.title+'" featured="'+obj.featured.toLowerCase()+'" subtitle="'+obj.subtitle+'" price="'+obj.price+'" period="'+obj.period+'" list="'+obj.list+'" btntext="'+obj.btntext+'" url="'+obj.href+'" target="'+obj.target+'"]';
		...
		},
		{
			...
			title:'Alert Box',
			allowSelection:false,
			fields:[{id:'icon', name:'Icon', values:uniqmag_different_themes_icons()},{id:'text', name:'Text', textarea:true},{id:'color', name:'Color', values:['Green', 'Blue', 'Red', 'Yellow']}],
			generateHtml:function(obj){
				
				return '[alert color="'+obj.color.toLowerCase()+'" icon="'+obj.icon.toLowerCase()+'"]'+obj.text+'[/alert]';
...

		{
			...
			title:'Lists',
			allowSelection:false,
			fields:[{id:'type-1', name:'Type', values:uniqmag_different_themes_icons()},{id:'lists', name:'Text', lists:true}],
			generateHtml:function(obj){
		...
		{
			id:'differentthemestestimonials',
			image:'btn-team-single.png',
			title:'Testimonials',
			allowSelection:false,
			fields:[{id:'type', name:'Type', values:['Centered', 'Left']},{id:'link', name:'Image URL', upload:true},{id:'name', name:'Name'},{id:'subtitle', name:'Name Subtitle'},{id:'text', name:'Text', textarea:true}],
			generateHtml:function(obj){
				switch(obj.type)
				{
					case 'Centered Image':
					 	var type='text_center';
					  	break;
					case 'Left Image':
					 	var type='0';
						break;
				...
				return '[testimonial name="'+obj.name+'" type="'+type+'" subtitle="'+obj.subtitle+'" url="'+obj.link+'"]'+obj.text+'[/testimonial]';
			}
		},
		{
...
differentthemesButtonManager={
	...
	showDialog:function(btn, ed){
		...
		dialog.find('#insertbtn').on( "click", function(event) {
			...
			dialog.keyup(function(){
			  if(event.keyCode == 13 && jQuery(".lists").is(":focus")) {
				...
				var n = Number(i)+Number(1);
				var ii;
				var icons = uniqmag_different_themes_icons();
				var iconsHTML='';
...
function uniqmag_different_themes_icons() {
