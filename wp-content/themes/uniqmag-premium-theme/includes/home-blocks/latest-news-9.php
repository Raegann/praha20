...
<div class="cs-row">
    ...
    <?php if ($my_query->have_posts()) : while ($my_query->have_posts()) : $my_query->the_post(); ?>
        <?php 
            $DF_builder->set_double(get_the_ID());
        ...
        ?>
         <div class="cs-col cs-col-6-of-12">
            ...
            <div class="cs-post-block-layout-6">
                <div class="cs-post-item hidden visible cs-animate-element<?php echo esc_attr($item_class);?>">
                   
                    <div class="cs-post-thumb">
                        <a href="<?php the_permalink();?>">
                            <?php $df_post->image_html( get_the_ID(), 417, 300, null, null, true );?>
                        </a>
                    </div>
