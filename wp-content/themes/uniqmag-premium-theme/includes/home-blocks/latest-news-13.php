                            ...
                            <div class="swiper-slide">
                                <div class="cs-post-item">
                                    <div class="cs-post-thumb">
                                        ...
                                        <?php $df_post->image_html( get_the_ID(), 1080, 465, null, THEME_NAME.'_homepage_image', true );?>
                                    </div>
            ...
            <div class="swiper-container cs-gallery-thumbs">
                <div class="swiper-wrapper">
                    <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
                        <div class="swiper-slide">
                            <?php $df_post->image_html( get_the_ID(), 100, 43, null, THEME_NAME.'_homepage_image', true );?>
                        </div>
                    <?php endwhile; ?>
                </div>
            </div>
